...
Widget build(BuildContext context)=>Scaffold(
  ...
  body:Container(
    ...
    child: ListView(
      ...
      SizedBox(height: 10,),
      buildAccountOption(context,'Personal Details',Icon(Icons.person)),
      _buildToggleOption(context,'Notifications',Icon(Icons.notifications)),
      _buildToggleOption(context,'Dark Theme',Icon(Icons.dark_mode)),
      buildAccountOption(context,'Invite A Friend',Icon(Icons.person_add)),
      buildAccountOption(context,'Delete Account',Icon(Icons.remove_circle))
      ],
    ),
  )
,
...
GestureDetector _buildToggleOption(BuildContext context,String title,Icon icon){
  return GestureDetector(
  onTap:(){
  },
      ...
      children:<Widget> [
        ...
        child: InkWell(
          ...
          child: AnimatedSwitcher(
            ...
            child: toggleValue? Icon(Icons.circle,color: Colors.white,size: 10.0,
            key: UniqueKey(),
            ) :Icon(Icons.circle,color: Colors.white,size:21,
             key: UniqueKey())
